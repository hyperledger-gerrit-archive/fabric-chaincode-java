...
Writing your own chaincode requires understanding Fabric platform,
Java and Gradle.

### Create Gradle project
You can use `fabric-chaincode-example-gradle` as staring point. Make sure that
your project build creates an "uber jar" (runnable jar that contains all dependencies) named `chaincode.jar` as result.
