...
public class ChaincodeFVTest {
    ...
    public void TestRegister() throws Exception {
        ...
        checkScenarioStep(server, 1, 1000, TimeUnit.MILLISECONDS);
    ...
    public void TestRegisterAndEmptyInit() throws Exception {
        ...
        server.send(initMsg);
        checkScenarioStep(server, 2, 1000, TimeUnit.MILLISECONDS);
    ...
    public void TestRegisterAndInitWithArguments() throws Exception {
        ...
        server.send(initMsg);
        checkScenarioStep(server, 4, 1000, TimeUnit.MILLISECONDS);
    ...
    public static void checkScenarioStep(final ChaincodeMockPeer s, final int step, final int timeout, final TimeUnit units) throws Exception {
        try {
