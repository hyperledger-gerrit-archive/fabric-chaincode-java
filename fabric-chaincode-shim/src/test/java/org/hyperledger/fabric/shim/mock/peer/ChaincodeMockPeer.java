...
public class ChaincodeMockPeer {
    ...
    public static ChaincodeMockPeer startServer(List<ScenarioStep> scenario, String logLevel) throws Exception {
        Map<String, String> env = new HashMap<>();
        env.put("CORE_CHAINCODE_LOGGING_SHIM", logLevel);
        env.put("CORE_CHAINCODE_LOGGING_LEVEL", logLevel);
        EnvUtil.setEnv(env);
