...
public class ChaincodeBaseTest {
    ...
    public void testInitializeLogging() throws Exception {
        ...
        Map<String, String> env = new HashMap<>();
        env.put("CORE_CHAINCODE_LOGGING_SHIM", "DEBUG");
        env.put("CORE_CHAINCODE_LOGGING_LEVEL", "DEBUG");
        env.put("CORE_CHAINCODE_ID_NAME", "mycc");
        env.put("CORE_PEER_ADDRESS", "localhost:7052");
        env.put("CORE_PEER_TLS_ENABLED", "true");
        env.put("CORE_PEER_TLS_ROOTCERT_FILE", "src/test/resources/ca.crt");
        ...
        assertEquals("Wrong debug level for org.hyperledger.fabric.shim ", Level.FINEST, Logger.getLogger("org.hyperledger.fabric.shim").getLevel());
    }
}
