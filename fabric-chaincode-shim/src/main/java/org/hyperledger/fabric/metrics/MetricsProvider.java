...
public interface MetricsProvider {
	...
	/**
	 * Pass a reference to this service for information gathering.  This is related
	 * specific to the handling of tasks within the chaincode. i.e. how individual transactions
