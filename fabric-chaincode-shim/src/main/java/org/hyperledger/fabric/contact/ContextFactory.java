...
public class ContextFactory {
    ...
    public Context createContextRO(final ChaincodeStub stub) {
        context.set(new NaiveContextRO(stub));
        return context.get();
    }
    ...
    static class NaiveContextRW extends NaiveContextRO {
    ...
    static class NaiveContextRO implements Context {
        ChaincodeStub context;
        public NaiveContextRO(ChaincodeStub stub) {
            context = stub;
        }
        ...
        @Override
        public void putState(String key, byte[] value) {
            throw new IllegalStateException("Can't invoke putState for RO context");
        }

        @Override
        public void setStateValidationParameter(String key, byte[] value) {
            throw new IllegalStateException("Can't invoke setStateValidationParameter for RO context");
        }

        @Override
        public void delState(String key) {
            throw new IllegalStateException("Can't invoke delState for RO context");
        }
        ...
        @Override
        public void putPrivateData(String collection, String key, byte[] value) {
            throw new IllegalStateException("Can't invoke putPrivateData for RO context");
        }

        @Override
        public void setPrivateDataValidationParameter(String collection, String key, byte[] value) {
            throw new IllegalStateException("Can't invoke setPrivateDataValidationParameter for RO context");
        }

        @Override
        public void delPrivateData(String collection, String key) {
            throw new IllegalStateException("Can't invoke delPrivateData for RO context");
        }
