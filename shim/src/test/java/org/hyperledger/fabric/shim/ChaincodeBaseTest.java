...
public class ChaincodeBaseTest {
	...
	public void toJsonString() throws Exception {
		ChaincodeShim.ChaincodeMessage message = ChaincodeShim.ChaincodeMessage.newBuilder()
				.setType(ChaincodeShim.ChaincodeMessage.Type.ERROR)
				.setPayload(ByteString.copyFromUtf8("message"))
				.setTimestamp(Timestamp.newBuilder().setNanos(12345).build())
				.setTxid("txId")
				.build();
		assertThat(ChaincodeBase.toJsonString(message), equalTo("{\n" +
				"  \"type\": \"ERROR\",\n" +
				"  \"timestamp\": \"1970-01-01T00:00:00.000012345Z\",\n" +
				"  \"payload\": \"bWVzc2FnZQ==\",\n" +
				"  \"txid\": \"txId\"\n" +
				"}"));
	}
