...
class ChaincodeStubImpl implements ChaincodeStub {
	...
	private Function<QueryResultBytes, KV> queryResultBytesToKv = queryResultBytes -> {
		try {
	...
	private Function<QueryResultBytes, KvQueryResult.KeyModification> queryResultBytesToKeyModification = queryResultBytes -> {
		try {
