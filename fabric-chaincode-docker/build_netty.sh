...
if echo $BINTARGETS | grep -q `uname -m`; then
	...
	mv /root/.m2/repository/io/netty/netty-tcnative-boringssl-static/2.0.15.Final/netty-tcnative-boringssl-static-2.0.15.Final-linux-ppcle_64.jar /root/.m2/repository/io/netty/netty-tcnative-boringssl-static/2.0.15.Final/netty-tcnative-boringssl-static-2.0.15.Final.jar
else
	exit 0
fi
